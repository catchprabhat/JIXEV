        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Empowering EV-Ready Living with mobile charging solutions that bring the future to your doorstep.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Doorstep EV Charging</li>
              <li className="text-gray-400">On-Demand Charging</li>
              <li className="text-gray-400">Scheduled Charging</li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+91 7737537655</span>
              </li>
              <li className="flex items-center">
                <Mail size={20} className="mr-2 text-green-400" />
                <span className="text-gray-400">jixevsolutions@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
